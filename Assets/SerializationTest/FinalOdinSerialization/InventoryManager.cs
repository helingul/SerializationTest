...
namespace FinalSaveSystem
{
    ...
    public class InventoryManager : ISaveable
    {
        ...
        public void Save(GameSaveData saveData)
        {
            saveData.inventoryManager = this;
        }

        public void LoadData(GameSaveData saveData)
        {
            //ReflectionHelper.CopyFields(this, saveData.inventoryManager);

            items = saveData.inventoryManager.items;
            gold = saveData.inventoryManager.gold;
            testDictionary = saveData.inventoryManager.testDictionary;
            dateTime = saveData.inventoryManager.dateTime;
            testIntArray = saveData.inventoryManager.testIntArray;
            testNestedFloatArray = saveData.inventoryManager.testNestedFloatArray;
            testNestedFloatArray = saveData.inventoryManager.testNestedFloatArray;
        }
